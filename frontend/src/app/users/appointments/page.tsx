    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-2xl mx-auto px-6 py-12 text-center">
          <h1 className="text-2xl font-bold text-brand-blue font-poppins mb-4">
            My appointments
          </h1>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 pb-16">
        <h1 className="text-2xl font-bold text-brand-blue font-poppins mt-4 mb-6 flex items-center gap-2">
        ...
        {appointments.length === 0 ? (
          <div className="rounded-2xl border border-gray-200 bg-white p-8 text-center">
            ...
            <Link
              href="/expert-net"
              className="inline-flex items-center gap-2 text-brand-blue hover:text-brand-orange font-inter text-sm font-medium"
            >
              ...
              >
                <div className="flex flex-wrap items-start justify-between gap-2">
                  <div>
                    ...
                    {apt.message && (
                      <p className="text-sm text-gray-500 font-inter mt-2 italic">
                        {apt.message}
                      </p>
                    )}
                  </div>
